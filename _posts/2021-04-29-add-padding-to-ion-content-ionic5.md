...
date: 2021-04-29
---
To add padding around ion-content component in ionic 5, Add the following CSS custom properties in SCSS file associated with the page. For example to add 
